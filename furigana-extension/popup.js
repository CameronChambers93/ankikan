...
async function loadSettings() {
  ...
  for (const cat of ['unlearned', 'learning', 'learned']) {
    ...
    $(`${cat}-bg-color`).value = overrides.backgroundColor ?? '';
...
function currentStyleSettings() {
  return {
    ...
    unlearned: {
      ...($('unlearned-bg-color').value ? { backgroundColor: $('unlearned-bg-color').value } : {}),
      ...($('unlearned-bg-opacity').value !== '' ? { backgroundOpacity: Number($('unlearned-bg-opacity').value) } : {}),
    },
    learning: {
      ...($('learning-bg-color').value ? { backgroundColor: $('learning-bg-color').value } : {}),
      ...($('learning-bg-opacity').value !== '' ? { backgroundOpacity: Number($('learning-bg-opacity').value) } : {}),
    },
    learned: {
      ...($('learned-bg-color').value ? { backgroundColor: $('learned-bg-color').value } : {}),
      ...($('learned-bg-opacity').value !== '' ? { backgroundOpacity: Number($('learned-bg-opacity').value) } : {}),
    },
  };
}
